...
export const codemirrorLightTheme = EditorView.theme(
  {
    ...
    '.cm-panels.cm-panels-top': { borderBottom: `2px solid ${config.dropdownBorder}` },
    '.cm-panels.cm-panels-bottom': { borderTop: `2px solid ${config.dropdownBorder}` },
...
export const codemirrorLightHighlightStyle = HighlightStyle.define([
...
export const codemirrorLight: Extension = [
  ...
  syntaxHighlighting(codemirrorLightHighlightStyle),
];
